        ...
        datasets: [
            {
                ...
                data: totalRevenueData.map((r) => {
                    ...
                    return { x: d, y: r.total_paid_amount + r.total_paid_fee };
                }),
            },
        ],
    },
...
const paymentsMethodChartData = JSON.parse(paymentsMChartElem.dataset.payments);
        ...
        datasets: [
            {
                ...
                backgroundColor: [`${COLORS.primary}50`, `${COLORS.danger}50`],
            },
        ],
    },
    options: {
